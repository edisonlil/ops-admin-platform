...
CREATE INDEX IF NOT EXISTS idx_role_data_scopes_role ON role_data_scopes(role_key, deleted);
CREATE INDEX IF NOT EXISTS idx_role_data_scopes_resource ON role_data_scopes(resource_key, action, deleted);

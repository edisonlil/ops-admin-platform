CREATE TABLE IF NOT EXISTS data_resource_descriptors (
    ...
    resource_id_column TEXT NOT NULL DEFAULT 'id',
    ...
    access_mode TEXT NOT NULL DEFAULT 'owner_columns',
    relation_table TEXT NOT NULL DEFAULT '',
    relation_resource_id_column TEXT NOT NULL DEFAULT '',
    relation_user_column TEXT NOT NULL DEFAULT '',
    relation_department_column TEXT NOT NULL DEFAULT '',
    relation_tenant_column TEXT NOT NULL DEFAULT 'tenant_id',
    relation_deleted_column TEXT NOT NULL DEFAULT 'deleted',
    relation_resource_key_column TEXT NOT NULL DEFAULT '',
    relation_resource_key_value TEXT NOT NULL DEFAULT '',
    relation_subject_type_column TEXT NOT NULL DEFAULT '',
    relation_subject_type_user_value TEXT NOT NULL DEFAULT '',
    relation_subject_type_department_value TEXT NOT NULL DEFAULT '',

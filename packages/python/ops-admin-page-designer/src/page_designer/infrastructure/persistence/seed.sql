...
SELECT 'page-designer', 'tenant', '页面设计', 'directory', '/page-designer', 'page-designer', '', 'DashboardOutlined', '', '', 860, TRUE
WHERE NOT EXISTS (SELECT 1 FROM menus WHERE menu_key = 'page-designer');

INSERT INTO menus (menu_key, menu_scope, label, menu_type, path, route_name, component, icon, parent_key, permission_code, sort_order, is_visible)
SELECT 'page-designer-pages', 'tenant', '页面管理', 'page', '/page-designer/pages', 'page-designer-pages', '/page-designer/pages/index', 'DashboardOutlined', 'page-designer', 'page_designer:page:manage', 861, TRUE
WHERE NOT EXISTS (SELECT 1 FROM menus WHERE menu_key = 'page-designer-pages');

INSERT INTO menus (menu_key, menu_scope, label, menu_type, path, route_name, component, icon, parent_key, permission_code, sort_order, is_visible)
SELECT 'page-designer-create', 'tenant', '新建页面', 'action', '', '', '', '', 'page-designer-pages', 'page_designer:page:manage', 8611, TRUE
WHERE NOT EXISTS (SELECT 1 FROM menus WHERE menu_key = 'page-designer-create');

INSERT INTO menus (menu_key, menu_scope, label, menu_type, path, route_name, component, icon, parent_key, permission_code, sort_order, is_visible)
SELECT 'page-designer-publish', 'tenant', '发布页面', 'action', '', '', '', '', 'page-designer-pages', 'page_designer:page:manage', 8612, TRUE

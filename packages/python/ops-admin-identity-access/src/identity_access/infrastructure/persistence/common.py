...
DEFAULT_MENU_METADATA: dict[str, dict[str, str]] = {
    ...
    "message-chat-bots": {"menu_type": "page", "component": "/messaging/chat-bots/index", "menu_scope": "tenant"},
    "message-chat-bots-create": {"menu_type": "action", "component": "", "menu_scope": "tenant"},
    "message-chat-bots-update": {"menu_type": "action", "component": "", "menu_scope": "tenant"},
    "message-chat-bots-enable": {"menu_type": "action", "component": "", "menu_scope": "tenant"},
    "message-chat-bots-disable": {"menu_type": "action", "component": "", "menu_scope": "tenant"},
    "message-chat-bots-test": {"menu_type": "action", "component": "", "menu_scope": "tenant"},
    ...
    "ai-platform-capabilities-manage": {"menu_type": "action", "component": "", "menu_scope": "platform"},
    ...
    "dataset-management": {"menu_type": "page", "component": "/datasets/manage/index", "menu_scope": "platform"},
    "dataset-management-create": {"menu_type": "action", "component": "", "menu_scope": "platform"},
    "dataset-management-update": {"menu_type": "action", "component": "", "menu_scope": "platform"},
    "dataset-management-delete": {"menu_type": "action", "component": "", "menu_scope": "platform"},
    "dataset-management-publish": {"menu_type": "action", "component": "", "menu_scope": "platform"},
    "dataset-management-preview": {"menu_type": "action", "component": "", "menu_scope": "platform"},
...
TENANT_RETIRED_DATASET_MENU_KEYS = [
    "dataset-management",
    "dataset-management-create",
    "dataset-management-update",
    "dataset-management-delete",
...
TENANT_ADMIN_EXTRA_PERMISSION_CODES = [
    ...
    "messaging:chat_bots:view",
    "messaging:chat_bots:create",
    "messaging:chat_bots:update",
    "messaging:chat_bots:enable",
    "messaging:chat_bots:disable",
    "messaging:chat_bots:test",
...
def ensure_default_rbac(conn: Any) -> None:
    ...
    _run_init_step("default RBAC: retire tenant dataset menus", lambda: retire_tenant_menu_keys(conn, TENANT_RETIRED_DATASET_MENU_KEYS))
...
def ensure_file_management_permissions(conn: Any) -> None:
    permission_rows = [
        ("system:menus:assign_tenants", "配置租户菜单", "配置租户可以使用哪些租户级菜单"),
    ...
    permission_rows.extend(
        [
            ...
            ("ai_capabilities:platform_manage", "Platform AI capability manage", "Create and update platform AI capabilities"),
...
def ensure_platform_default_menus(conn: Any) -> None:
    platform_menu_rows = [
        ...
        ("dataset-management", "平台数据集", "/datasets/manage", "dataset-management", "table", "platform-management", "datasets:dataset:read", 1098),
        ("dataset-management-create", "新建平台数据集", "", "", "", "dataset-management", "datasets:dataset:manage", 10981),
        ("dataset-management-update", "编辑平台数据集", "", "", "", "dataset-management", "datasets:dataset:manage", 10982),
        ("dataset-management-delete", "删除平台数据集", "", "", "", "dataset-management", "datasets:dataset:manage", 10983),
        ("dataset-management-publish", "发布平台数据集", "", "", "", "dataset-management", "datasets:dataset:publish", 10984),
        ("dataset-management-preview", "预览平台数据集", "", "", "", "dataset-management", "datasets:dataset:preview", 10985),
        ...
        ("menu-tenant-assignment", "租户菜单配置", "/rbac/menu-tenant-assignments", "menu-tenant-assignment", "ApartmentOutlined", "rbac", "system:menu:access", 1014),
        ("menu-tenant-assignment-save", "保存租户菜单配置", "", "", "", "menu-tenant-assignment", "system:menus:assign_tenants", 10141),

...
CREATE INDEX idx_user_reporting_relationships_user ON user_reporting_relationships(tenant_id, user_id, deleted);
CREATE INDEX idx_user_reporting_relationships_manager ON user_reporting_relationships(tenant_id, manager_user_id, deleted);

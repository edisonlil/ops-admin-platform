...
LOCAL_PACKAGE_SRC = {
    ...
    "page_designer": REPO_ROOT / "packages" / "python" / "ops-admin-page-designer" / "src",
    "file_management": REPO_ROOT / "packages" / "python" / "ops-admin-file-management" / "src",
    "datasets": REPO_ROOT / "packages" / "python" / "ops-admin-datasets" / "src",
...
LOCAL_ENTRYPOINTS = {
    ROUTER_GROUP: {
        ...
        "page_designer": "page_designer.entrypoints:router",
        "file_management": "file_management.entrypoints:router",
        "datasets": "datasets.entrypoints:router",
    ...
    INIT_TASK_GROUP: {
        ...
        "page_designer": "page_designer.entrypoints:init_tasks",
        "file_management": "file_management.entrypoints:init_tasks",
        "datasets": "datasets.entrypoints:init_tasks",

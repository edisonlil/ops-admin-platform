    ...
    <div class="view-account-container animate__animated animate__fadeInDown">
      <div class="view-account-top">
        <div class="view-account-top-logo">
          <img v-if="platformLogoUrl" :src="platformLogoUrl" :alt="platformName" />
          <strong :style="{ fontSize: `${platformNameFontSize}px` }">{{ platformName }}</strong>
        </div>
      ...
      <div class="view-account-form">
        ...
        <n-form
          ...
          class="login-form"
        >
          <n-form-item path="tenant_key" class="tenant-item">
            <n-input
...
<script lang="ts" setup>
  ...
  import { BusinessOutline, PersonOutline, LockClosedOutline, LogoGithub, LogoFacebook, LogoWechat } from '@vicons/ionicons5';
...
<style lang="less" scoped>
  .view-account {
    ...
    .tenant-item, .username-item, .password-item {
      margin-bottom: 24px;
    }
